...
import UpdateMovie from './Modal/UpdateMovie'
...
return(
    ...
    <div className='p-0'>
        ...
        busy={busy}
        />
        <UpdateMovie visible={showUpdateModal} movieId={selectedMovieId} onSuccess={handleOnUpdate} />
    </div>
        </>
    )
                                ...
                                <div className='space-x-1'>
                                    {genres.map((g,index)=>{
                                        return(
                                            ...
                                            dark:text-white text-xs' >{g}</span>
                                        )
                                    })}
