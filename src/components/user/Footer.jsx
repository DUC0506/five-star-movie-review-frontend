...
export default function Footer() {
  return (
    <div className='mt-20'>
    <footer aria-label="Site Footer" class="bg-white dark:bg-primary border-t-2  dark:border-white-600 border-black-600 ">
    <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
      <div class="mx-auto max-w-md">
        <strong
          class="block text-center text-xl font-bold text-gray-900 dark:text-white sm:text-3xl"
        >
          Want us to email you with the latest movie news?
        </strong>
        ...
        <form class="mt-6">
          <div class="relative max-w-lg">
            ...
            <button
              class="absolute end-1 right-1 top-1/2 -translate-y-1/2 rounded-full bg-blue-600 px-5 py-3 text-sm font-medium text-white transition hover:bg-blue-700"
            >
              Subscribe
            </button>
          </div>
      ...
      <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
        <div class="mx-auto max-w-sm lg:max-w-none">
          <p
            class="mt-4 text-center text-gray-500 dark:text-gray-400 lg:text-left lg:text-lg"
          >
