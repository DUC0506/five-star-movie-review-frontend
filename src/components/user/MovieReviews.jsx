...
import EditRatingModal from '../Modal/EditRatingModal'
...
export default function MovieReviews() {
    ...
    const findProfileOwnersReview=()=>{
      ...
      if(!matched) return updateNotification('error','You do not have any review!')
    ...
    <div className='dark:bg-primary bg-white min-h-screen pb-10'>
        <Container className="xl:px-0 px-2 py-8">
            <div className='flex justify-between items-center'>
              ...
              { profileId ? <CustomButtonLink label={profileOwnersReview ? 'View All':'Find My Review'} onClick={findProfileOwnersReview}></CustomButtonLink>:null}
          ...
          { profileOwnersReview?(
            <div>
                ...
                <div className="flex space-x-3 dark:text-white text-primary text-x p-3">
        ...
        busy={busy}
         title='Are you sure ?' subtitle='This action will remove this review
        permanently'/>
...
const ReviewCard=({review})=>
{
    ...
    {/* <div className="flex items-center justify-center w-14 h-14 rounded-full bg-light-subtle dark:bg-dark-subtle
    ...
    <blockquote class="rounded-lg bg-gray-100 p-4 w-full">
    <div class="flex items-center gap-4">
    <div className="flex items-center justify-center w-14 h-14 rounded-full bg-primary dark:bg-light-subtle
        text-white text-xl select-none">
            {getNameInitial(owner.name)}
        </div>
    ...
    <div>
        ...
        <p class="mt-1 text-lg font-medium text-gray-700">{owner.name}</p>
    </div>
    </div>

    <p class="line-clamp-2 sm:line-clamp-none mt-4 ">
        {content}
    </p>
</blockquote>
</div>)
